        ...
        <div className="md:col-span-2 space-y-8">
              ...
              <div className="flex justify-between items-end">
                <div>
                  ...
                  <p className="text-3xl font-bold font-mono">
                    {org.queryCount} <span className="text-lg text-muted-foreground font-normal">/ {org.queryLimit}</span>
                  </p>
                </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {/* Starter Plan */}
              <Card className={`shadow-none border-border relative ${org.plan === 'starter' ? 'ring-2 ring-primary border-primary' : ''}`}>
                {org.plan === 'starter' && (
                ...
                <CardFooter>
                  <Button variant="outline" className="w-full" disabled={org.plan === 'starter'}>
                    {org.plan === 'starter' ? 'Current Plan' : 'Downgrade'}
                  </Button>
                </CardFooter>
              </Card>

              {/* Pro Plan */}
              <Card className={`shadow-none border-border relative ${org.plan === 'pro' ? 'ring-2 ring-primary border-primary' : ''}`}>
                {org.plan === 'pro' && (
                  <div className="absolute top-0 right-0 bg-primary text-primary-foreground text-xs font-bold px-3 py-1 rounded-bl-lg rounded-tr-lg">
                    CURRENT
                  </div>
                ...
                <CardFooter>
                  <Button 
                    ...
                    disabled={org.plan === 'pro' || loading}
                  >
                    {loading ? 'Processing...' : org.plan === 'pro' ? 'Current Plan' : 'Upgrade to Pro'}
                  </Button>
                </CardFooter>
              </Card>
            </div>
          ...
          <Card className="shadow-none border-border bg-muted/20">
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <p className="text-sm mt-1">$29.00 on Jul 1, 2026</p>
              </div>
